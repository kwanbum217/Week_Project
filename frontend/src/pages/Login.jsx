  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-orange-200/30 blur-3xl animate-float-gentle" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-blue-200/30 blur-3xl animate-float-gentle" style={{ animationDelay: '2s' }} />
      </div>

      <div className="relative z-10 w-full max-w-md px-4">
        <div className="mooa-glass-card animate-fade-in">
          <Box textAlign="center" mb={8}>
            <div className="mx-auto w-24 h-24 mb-4 rounded-full overflow-hidden shadow-lg border-4 border-white">
              <img
          ...
          <VStack spacing={3} mt={8}>
            ...
            <a
              ...
              className="w-full flex items-center justify-center gap-3 py-4 px-6 bg-white border-2 rounded-xl transition-all duration-300 hover:shadow-md"
              style={{
                borderColor: '#E8EEF4',
            ...
            <a
              ...
              className="w-full flex items-center justify-center gap-3 py-4 px-6 rounded-xl transition-all duration-300 hover:opacity-90"
              style={{
                background: '#FEE500',
                fontSize: 'var(--font-size-lg)',
                color: '#000000',
